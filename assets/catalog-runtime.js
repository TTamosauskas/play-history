...
(() => {
  ...
  const ADDITION_FILES = [
    ...
    'additions_1830s.json',
    'additions_1890s.json',
    'additions_1900s.json',
    'additions_1910s.json',
    'additions_1920s.json',
    'additions_1930s_a.json',
    'additions_1930s_b.json',
    'additions_1930s_c.json',
    'additions_1930s_d.json',
    ...
    'additions_1970s_research.json',
    'additions_1980s.json',
    'additions_1980s_research.json',
  ...
  const AUDIT_FILES = [
    ...
    'context_pre1900_1590_1629.json',
    'context_pre1900_1630_1679.json',
    'context_pre1900_1680_1719.json',
    'context_pre1900_1390_1459.json',
    'context_pre1900_1460_1519.json',
    'context_pre1900_1520_1589.json',
